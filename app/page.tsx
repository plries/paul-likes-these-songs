...
export default function Home() {
  return (
    <main className="relative grid min-h-screen bg-neutral-100 px-5 font-sans md:px-10">
      <div className="grid min-h-full grid-cols-1 grid-rows-[min-content] gap-4 border-x border-x-neutral-950/5 p-5 pb-48 md:grid-cols-3 md:p-10 lg:grid-cols-4">
        {tracks
          .sort(
