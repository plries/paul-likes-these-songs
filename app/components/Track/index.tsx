    ...
    <div className="relative flex w-full flex-col pb-7.5">
      ...
      >
        ...
        >
          ...
          <p
            className={`ml-1 ml-auto line-clamp-1 w-fit -rotate-2 px-2 py-0.5 text-xs ${hook.getTextColorFromHex(track.colors.muted)}`}
            style={{
        ...
        <p
          className={`z-1 mb-0.5 w-fit px-2 py-0.5 font-mono text-xs ${hook.getTextColorFromHex(track.colors.vibrant)}`}
          style={{
